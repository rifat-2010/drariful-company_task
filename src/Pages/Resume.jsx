    ...
    const loadProjects = async () => {
      try {
        ...
        const ongoing = data.filter(
          (p) => p.status === "Ongoing" || p.status === "Submitted",
        );
        setProjects(ongoing);
      } catch (err) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 pt-6 border-t border-gray-100">
            ...
            <div className="flex items-center gap-3 text-gray-600">
              ...
              <a
                href="mailto:arifurrahmandm@gmail.com"
                className="text-sm font-medium hover:text-[#003878] transition-colors"
              >
            ...
            <div className="flex items-center gap-3 text-gray-600">
              ...
              <a
                href="https://dmarifurrahman.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-medium hover:text-[#003878] transition-colors flex items-center gap-1"
              >
        ...
        <div className="bg-gradient-to-r from-[#001A33] via-[#003878] to-[#012d60] rounded-2xl shadow-lg border-l-8 border-[#e88d67] text-white p-6 md:p-8 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs uppercase tracking-widest text-[#e88d67] font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <span className="block text-xs text-blue-200 uppercase font-semibold">
                  Accreditation Body
                </span>
                <span className="text-sm font-bold text-white">
                  EIAC (Emirates Int. Accreditation Centre)
                </span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <span className="block text-xs text-blue-200 uppercase font-semibold">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                ...
                <span className="text-sm font-bold text-white">
                  Molecular Diagnostics of Cancer (NGS)
                </span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <span className="block text-xs text-blue-200 uppercase font-semibold">
            ...
            <p className="text-sm text-blue-100 leading-relaxed text-justify">
              <strong className="text-white">Clinical Implication:</strong> This
              accreditation provides oncologists and clinicians across
              Bangladesh with the highest level of confidence and trust in
              NGS-based molecular diagnostic results — enabling precision
              treatment decisions backed by internationally validated quality
              assurance. TMSS Biomolecular Lab now delivers cost-effective,
              world-class cancer genomics testing that was previously
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
              <span className="block text-3xl font-extrabold text-[#003878]">
                &gt;60,000
              </span>
              <span className="text-sm font-semibold text-gray-500">
                Pathology, Cytology & IHC Cases Signed Out
              </span>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <span className="text-sm font-semibold text-gray-500">
                NGS Cancer Cases Validated & Authorized
              </span>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <span className="text-sm font-semibold text-gray-500">
                Peer-Reviewed Papers (37 Pub, 7 Sub)
              </span>
            </div>
          </div>
        </div>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 rounded-2xl p-6 mb-6">
            <h3 className="text-lg font-bold mb-2">
              Unable to load resume projects
            </h3>
            <p className="text-sm">
              {error.message || "The backend CMS API is unavailable."}
            </p>
          </div>
        )}
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                ...
                <h2 className="text-2xl font-bold text-[#001A33]">
              ...
              <div className="relative border-l-2 border-blue-100 ml-4 pl-6 space-y-8">
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-2">
                    <h3 className="text-lg font-bold text-[#001A33]">
                      Laboratory Director
                    </h3>
                  ...
                  <h4 className="text-sm font-bold text-[#003878] mb-3">
                    TMSS Biomolecular Laboratory
                  </h4>
                  <ul className="space-y-2 text-sm text-gray-600 text-justify">
                    <li className="flex items-start gap-2">
                      <ChevronRight
                        size={16}
                        className="text-[#e88d67] shrink-0 mt-0.5"
                      />
                      <span>
                        <strong>★ FOUNDER:</strong> Established Bangladesh's
                        first ISO 15189:2022 accredited NGS molecular cancer
                        diagnostics laboratory—the only such lab in South Asia.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      />
                      <span>
                        Led the complete ISO 15189:2022 accreditation process
                        with EIAC (ILAC-signatory body) to achieve international
                        quality and competence in cancer genomics (March 2026).
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      />
                      <span>
                        Designed and implemented a comprehensive Quality
                        Management System (QMS) encompassing SOPs, internal
                        audits, and LIMS integration.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      />
                      <span>
                        Oversees complete NGS workflows: library preparation,
                        sequencing, bioinformatics pipelines, and clinical
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong>
                          &gt;1,000 NGS-based cancer molecular reports
                        </strong>{" "}
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      />
                      <span>
                        Introduced cost-effective cancer genomic panels,
                        ensuring accessibility for underprivileged patients.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 text-justify">
                    <li className="flex items-start gap-2">
                      ...
                      />
                      <span>
                        Teaches and mentors undergraduate and postgraduate
                        medical trainees in histopathology, cytopathology, and
                        molecular pathology.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      />
                      <span>
                        Leads integrated teaching programmes, faculty
                        development initiatives, and medical education
                        innovation for Gen Z learners.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      <span>
                        Signed out{" "}
                        <strong>
                          &gt;60,000 pathology, cytopathology, and
                          immunohistochemistry (IHC) cases
                        </strong>
                        .
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      />
                      <span>
                        Member: Tumor Board, TMSS Cancer Centre; Seminar &
                        Integrated Teaching Committee; Journal & Research
                        Committee.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-bold text-[#003878] mb-3">
                    TMSS Cyto-Histopathology Laboratory
                  </h4>
                  <ul className="space-y-2 text-sm text-gray-600 text-justify">
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      />
                      <span>
                        Established high-volume histopathology, cytopathology,
                        and IHC diagnostic services.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight
                      ...
                      />
                      <span>
                        Developed laboratory quality assurance systems and
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-gray-600 text-justify pl-4">
                    Led the development and management of histopathology
                    laboratories, mentored medical residents, and initiated
                    academic research.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 mb-4 pb-4 border-b border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Actively driving genomic oncology and medical pedagogy
                    research
                  </p>
                </div>
              </div>
              ...
              <div className="max-h-[500px] overflow-y-auto pr-2 space-y-4 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
                {loading ? (
                  ...
                  projects.map((project, idx) => (
                    <div
                      key={project.id || idx}
                      className="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-blue-100 transition-colors flex gap-4 animate-fade-in"
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-1.5">
                          <span className="text-[10px] bg-blue-50 text-[#003878] px-2 py-0.5 rounded font-bold border border-blue-100">
                            {project.field}
                          </span>
                          <span
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-5">
                <div className="border-l-2 border-blue-500 pl-4">
                  <h3 className="text-sm font-bold text-[#001A33]">
                    MD (Pathology)
                  </h3>
                ...
                <div className="border-l-2 border-gray-200 pl-4">
                  ...
                  <p className="text-xs font-medium text-gray-600">
                    Nur Mohammad Rifles Public School & College, Dhaka Board
                  </p>
                </div>
                <div className="border-l-2 border-gray-200 pl-4">
                  <h3 className="text-sm font-bold text-[#001A33]">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  <CheckCircle
                    size={16}
                    className="text-[#e88d67] shrink-0 mt-1"
                  />
                  <div>
                    <h4 className="text-sm font-bold text-[#001A33]">
                      Advanced Molecular Pathology, QMS & ISO 15189
                    </h4>
                    <p className="text-xs text-gray-500">
                      Xing Holdings, Brisbane, Australia · 2022–2023
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-[#001A33]">
                      NGS Library Preparation Training
                    </h4>
                    <p className="text-xs text-gray-500">
                      NGeneBio Lab, South Korea · September 2025
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-[#001A33]">
                      Certified Clinical Trials Course
                    </h4>
                    <p className="text-xs text-gray-500">
                      Johns Hopkins University (Online) · 2024
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-[#001A33]">
                      Next Generation Sequencing (NGS) Training
                    </h4>
                    <p className="text-xs text-gray-500">
                      Central Dogma Lab, Dhaka · December 2024
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-[#001A33]">
                      Medical Education Certified Course (CMed)
                    </h4>
                    <p className="text-xs text-gray-500">
                      BIRDEM, Dhaka · 2021 (6 months)
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <ul className="space-y-2 text-xs font-semibold text-gray-600">
                <li className="flex items-center gap-2">
                  ...
                  <span>
                    Member, Association of Molecular Pathology, USA (Since 2025)
                  </span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-[#e88d67] rounded-full shrink-0"></div>
                ...
                <li className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-[#e88d67] rounded-full shrink-0"></div>
                  <span>
                    Admin — "Easypathology" & "Bangladesh Surgical Pathology"
                  </span>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <p className="text-xs text-gray-600 flex items-center gap-1.5 mb-1">
                    ...
                    <a
                      href="mailto:drpaulmainwaring@gmail.com"
                      className="hover:text-[#003878]"
                    >
                      drpaulmainwaring@gmail.com
                    </a>
                  </p>
                ...
                <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <p className="text-xs text-gray-600 flex items-center gap-1.5 mb-1">
                    <Mail size={12} className="text-gray-400" />
                    <a
                      href="mailto:tmsshealth@gmail.com"
                      className="hover:text-[#003878]"
                    >
                      tmsshealth@gmail.com
                    </a>
                  </p>
                  <p className="text-xs text-gray-600 flex items-center gap-1.5">
                    <Phone size={12} className="text-gray-400" />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link
            to="/publication"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#003878] text-white font-bold rounded-xl hover:bg-[#001A33] transition-colors shadow-sm"
          >
