...
export default function Gallery() {
  ...
  return (
    <div className="w-11/12 mx-auto mb-5 md:mb-10">
      <h1 className="text-center text-2xl lg:text-3xl font-bold heading mb-2">
        Gallery Highlights
      </h1>
      <p className="text-sm md:text-base text-center primary-text mb-5">
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden">
          ...
          >
            {loading ? (
              <div className="w-full py-16 text-center bg-white rounded-xl border border-gray-100">
                <span className="loading loading-spinner loading-lg text-[#003878]"></span>
                <p className="mt-3 text-gray-500">Loading gallery preview...</p>
              </div>
            ) : error ? (
              <div className="w-full py-16 text-center bg-white rounded-xl border border-red-200">
                <p className="text-red-600 font-semibold">
                  Unable to load the gallery preview.
                </p>
      ...
      <div className="text-end mt-1">
        <Link
          onClick={scrollToTop}
          to={"/gallery"}
          className="sub-title font-semibold underline"
        >
          See More...
        </Link>
      </div>
