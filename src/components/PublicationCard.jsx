...
export default function PublicationCard({ publication }) {
  ...
  const displayYear =
    publication.year && publication.year !== "N/A" ? publication.year : null;
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300">
      ...
      <div className="p-5 border-b border-gray-100">
        <div className="flex justify-between items-start mb-2">
          {displayYear ? (
            <span className="text-sm font-medium sub-title">{displayYear}</span>
          ) : (
            <span className="text-sm font-medium sub-title opacity-0">
              &nbsp;
            </span>
          )}
        ...
        <h3 className="text-lg font-bold heading mb-1 line-clamp-2">
          {publication.title}
        </h3>
        <p className="primary-text text-sm italic mb-3">
          {publication.journal}
        </p>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-xs font-medium sub-title">
      ...
      >
        <div className="p-5 border-b border-gray-100 bg-gray-50">
          ...
          {publication.downloadAvailable && publication.downloadUrl && (
            <a
